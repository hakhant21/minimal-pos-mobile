<div class="space-y-6">
    ...
    <x-card padding="p-0">
        <a href="{{ route('sales.detail', $sale) }}"
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="mt-2">
                    <span class="text-lg font-bold text-gray-900 dark:text-white">Ks {{ number_format($sale->total, 2)
                        }}</span>
                </div>
                @if ($sale->notes)
    ...
    <x-card padding="p-0">
        <div class="px-4 py-12 text-center">
            ...
            <a href="{{ route('sales') }}"
                class="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300">
    ...
    <div
        class="flex items-center justify-between gap-4 rounded-xl border border-gray-200/80 bg-white px-5 py-4 shadow-sm dark:border-gray-700/80 dark:bg-gray-800/80">
