<div class="space-y-6">
    ...
    <div
        ...
        <div class="flex items-center gap-2 border-b border-red-200/50 px-4 py-2.5 dark:border-red-800/30">
            ...
            <h3 class="text-xs font-semibold uppercase tracking-wider text-red-800 dark:text-red-300">{{ __('Low Stock Products') }}
            </h3>
        </div>
    ...
    <form wire:submit="addStock" class="space-y-5">
        <div
            ...
            <div class="space-y-4">
                        ...
                        <div wire:click="selectProduct({{ $product->id }})" x-on:click="open = false"
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $product->name
                                 ...
                                 <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('Stock') }}: {{ $product->stock
                                    }}</span>
                            </div>
                        </div>
                        @endforeach
                ...
                @if ($product)
                <div>
                    <label for="unit_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('Unit Type') }}</label>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600 dark:text-gray-400">{{ __('Current Stock') }}</span>
                        <span
                ...
                <div>
                    <label for="quantity" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Quantity to Add') }}</label>
                ...
                <div>
                        <label for="purchaseCost"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Purchase Cost (per unit)') }}</label>
